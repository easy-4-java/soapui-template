...
[![Java](https://img.shields.io/badge/Java-21-orange)](https://github.com/easy-4-java/soapui-template) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](./LICENSE)

soapui-template ("Opt For SoapUI") is a thin, programmatic layer on top of the SoapUI engine
...
```groovy
implementation 'io.github.easy4j:soapui-template:3.0.x.x.20260630-SNAPSHOT'
```
